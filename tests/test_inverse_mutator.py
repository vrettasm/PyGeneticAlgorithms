...
class TestInverseMutator(unittest.TestCase):

    @classmethod
    def setUpClass(cls) -> None:
        print(">> TestInverseMutator - START -")

    # _end_def_

    @classmethod
    def tearDownClass(cls) -> None:
        print(">> TestInverseMutator - FINISH -", end='\n\n')
    # _end_def_
    ...
    def setUp(self) -> None:
        ...
        self.mut_op = InverseMutator(mutate_probability=1.0)
    # _end_def_
