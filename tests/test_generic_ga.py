    ...
    def setUp(self) -> None:
        ...
        pop = [Chromosome([Gene('a', lambda: str('x')),
               ...
               Chromosome([Gene('e', lambda: str('x')),
                                   Gene('f', lambda: str('x'))], fitness=2.0),
               Chromosome([Gene('1', lambda: str('x')),
                                   Gene('2', lambda: str('x'))], fitness=4.0),
               Chromosome([Gene('3', lambda: str('x')),
                                   Gene('4', lambda: str('x'))], fitness=5.0),
               Chromosome([Gene('5', lambda: str('x')),
                                   Gene('6', lambda: str('x'))], fitness=6.0),
               Chromosome([Gene('7', lambda: str('x')),
                                   Gene('8', lambda: str('x'))], fitness=7.0),
               Chromosome([Gene('h', lambda: str('x')),
                                   Gene('i', lambda: str('x'))], fitness=8.0),
